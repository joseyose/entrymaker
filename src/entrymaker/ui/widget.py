...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_edit = QtWidgets.QLabel(self.widget)
        self.label_edit.setObjectName("label_edit")
        self.verticalLayout.addWidget(self.label_edit)
        self.textedit_edit = QtWidgets.QTextEdit(self.widget)
        ...
        self.label_preview = QtWidgets.QLabel(self.layoutWidget)
        self.label_preview.setObjectName("label_preview")
        self.verticalLayout_2.addWidget(self.label_preview)
        self.textedit_preview = QtWidgets.QTextEdit(self.layoutWidget)
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit.setPlaceholderText(_translate("Form", "Separated by commas"))
        self.label.setText(_translate("Form", "Tags"))
        self.label_2.setText(_translate("Form", "Grok Score"))
